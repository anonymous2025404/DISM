...
# Datafile paths:
IMAGE_PATH = '' # mimic image root directory
# IMAGE_PATH = ""
DATASET_DIR = '' # processed dataset root directory
TRAIN_PATH = '' # train dataset
TEST_PATH = '' # test dataset
VAL_PATH = '' # validate dataset
MIMIC_SPLIT_PATH = '' # mimic split file
REPORT_PATH = '' # mimic report root directory

PRED_PROB_PATH = '' # probability file of model prediction, 13labels
PRED_LABEL_PATH = '' # probability file of model prediction, 14labels
PRED_VAL_PROB_PATH = "" # probability file of model prediction, validate dataset


SOURCE_INFO_PATH = "" # patients' clinical context
VDB_P_PATH = "" # text for vdb without patients' clinical context
VDB_P_INFO_PATH = "" # text for vdb with patients' clinical context
VDB_PATH = "" # vdb without patients' clinical context
VDB_INFO_PATH = "" # vdb with patients' clinical context

# generated reports
LLM_0SHOT_REPORT_G_PATH = "" # LLM 0-shot use group match
LLM_0SHOT_REPORT_S_PATH = "" # LLM 0-shot use single match
LLM_0SHOT_REPORT_G_PATH_INFO = "" # LLM 0-shot use group match with patients' clinical context
LLM_0SHOT_REPORT_S_PATH_INFO = "" # LLM 0-shot use single match with patients' clinical context
LLM_RAG_INFO = "" # LLM RAG with patients' clinical context
LLM_RAG = "" # LLM RAG without patients' clinical context
...
# Parameters related to image transforms
RESIZE = (320, 320)
CROP = 224

# Class names
CLASS = ["Atelectasis", "Cardiomegaly", "Consolidation", "Edema", "Enlarged Cardiomediastinum", "Fracture",
...
QWEN_7B = ""
LLM_USE = "qwen7b"
LORA_CKPT_INFO = "" # lora checkpoint

# Report_generation_settings
MATCH_TYPE = "group" # "single" or "group"
INFO_USE = True # whether use patients' clinical context
RAG_USE = False # whether use RAG
RAG_CKPT = "" # RAG checkpoint

# Eval settings
CHEXBERT_CKPT = '' # CheXbert checkpoint
